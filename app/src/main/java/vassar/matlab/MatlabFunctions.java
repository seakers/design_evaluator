...
//    }
    ...
    public static String stringArraytoStringWithSpaces(String[] array) {
        String res = array[0];
    ...
    public static String stringArraytoStringWith(String[] array, String ss) {
        String res = array[0];
        for (int i = 1; i < array.length; i++) {
            res += ss + array[i];
        }
    ...
    public static int sumRowBool(boolean[][] mat, int row) {
        int x = 0;
    ...
    public static ArrayList<String> jessList2ArrayList(ValueVector vv, Rete r) {
